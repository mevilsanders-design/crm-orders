...
let editingProductId = null; // ID товара, который сейчас редактируем
...
function deleteProduct(id) {
  if (!confirm('Удалить товар? Позиции в старых заказах останутся, но товар пропадёт из списка и больше нельзя будет добавить в новые заказы.')) return;
